  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-slate-900 text-white flex flex-col fixed h-full">
        ...
        <button
          onClick={() => navigate("/")}
          className="p-4 bg-slate-800 hover:bg-slate-700 transition text-sm text-center border-t border-slate-700"
        >
          ← Quitter l'admin
        </button>
      </aside>
      ...
      <main className="flex-1 ml-64">
        <header className="h-16 bg-white shadow-sm flex items-center justify-between px-8 sticky top-0 z-10">
          <h2 className="text-gray-700 font-semibold">Gestion Immobilière</h2>
          <div className="flex items-center gap-4">
            <span className="text-sm text-gray-500">Oussama El Alaoui</span>
            <div className="w-8 h-8 rounded-full bg-teal-500 text-white flex items-center justify-center text-xs">
              OA
            </div>
          </div>
        </header>
