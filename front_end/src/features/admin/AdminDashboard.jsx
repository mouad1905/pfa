      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-xs border border-slate-100 space-y-6">
          ...
          <div className="border-t border-slate-100 pt-6 space-y-4">
            <h4 className="text-sm font-bold text-slate-700">Audit & Modération</h4>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center p-3.5 bg-slate-50/50 rounded-xl border border-slate-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h5 className="font-semibold text-slate-800 text-sm">Hébergements</h5>
                    <p className="text-xs text-slate-400">{annonces.hebergements_valides} validés · {annonces.hebergements_rejetes} rejetés</p>
                  </div>
                </div>
              ...
              <div className="flex justify-between items-center p-3.5 bg-slate-50/50 rounded-xl border border-slate-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h5 className="font-semibold text-slate-800 text-sm">Cours de soutien</h5>
                    <p className="text-xs text-slate-400">{annonces.cours_valides} validés · {annonces.cours_rejetes} rejetés</p>
                  </div>
                </div>
